    ...
    <AppShell className="product-shell archive-shell" activeNav="아카이브" showBottomNav>
      <main className="archive-screen">
        ...
        {data ? <>
          ...
          <section className="archive-paper-section"><div className="archive-section-heading"><h2>장소 / 리뷰 관리</h2><Link to="/archive/manage">관리하기 &gt;</Link></div><p>저장한 장소와 작성한 리뷰를 확인할 수 있어요.</p><Link className="archive-inline-link" to="/archive/my-places">내가 만든 장소 보기 &gt;</Link></section>
